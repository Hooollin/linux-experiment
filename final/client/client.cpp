...
template <typename T> class CTCPClient {
    public:
        ...
        virtual ~CTCPClient() { delete[] m_strServerIP; }
    ...
    public:
        int Run(int encryptionFunction, const char *p) {
            ...
            if (connect(nClientSocket, (sockaddr *)&ServerAddress,
        ...
        void ClientFunction(int nConnectedSocket, int encryptionFunction,
                const char *p) {}
    ...
    public:
        ...
        void ClientFunction(int nConnectedSocket, int encryptionFunction,
            ...
            if (encryptionFunction == -1 && strcmp(p, "help") == 0) {
                ...
                write(nConnectedSocket, serializedContent.c_str(),
